...
function passDataProductsBeforeUpdate(itemId) {
    ...
    if (item.img.url2) document.querySelector(`#img2-update-${itemId}`).value = item.img.url2;
    if (item.img.color2) document.querySelector(`#color2-update-${itemId}`).value = item.img.color2;
    if (item.img.url2) document.querySelector(`#img3-update-${itemId}`).value = item.img.url3;
    if (item.img.color3) document.querySelector(`#color3-update-${itemId}`).value = item.img.color3;
    if (item.img.url3) document.querySelector(`#img4-update-${itemId}`).value = item.img.url4;
    if (item.img.color4) document.querySelector(`#color4-update-${itemId}`).value = item.img.color4;
